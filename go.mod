...
replace (
	...
	github.com/gophercloud/utils => github.com/gophercloud/utils v0.0.0-20210720165645-8a3ad2ad9e70
	...
	github.com/openshift-metal3/terraform-provider-ironic => github.com/hs0210/terraform-provider-ironic v0.4.8
